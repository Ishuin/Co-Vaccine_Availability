...
from .forms import DistrictForm, LocationForm
    ...
    if request.method == "GET":
        ...
        if state_form.is_valid():
            ...
            headers = {
                ...
                + " like Gecko) Chrome/90.0.4430.93 Safari/537.36 Edg/90.0.818.56",
            }
            res = requests.get(url=URL, params=PARAMS, headers=headers)
            list_of_districts = json.loads(res.content.decode())["districts"]
            return render(
                request,
                "available/districts_dropdown_options.html",
                {"districts": list_of_districts},
            )
